...
const MakeOffer = ({ isListed, selectedNft, listings, marketPlaceModule }) => {
    ...
    const buyItem = async (
        ...
        console.log(listingId, quantityDesired, marketPlaceModule, 'test done!')
    ...
    const sellItem = async e => {
        ...
        const listing = {
            ...
            assetContractAddress: "0xfBFb463C184b93C2d8659fe0311599001217FE68",
        ...
        const tx = await marketPlaceModule.direct.createListing(listing)
            .then(() => {
                ...
                confirmPurchase()
                setTimeout(() => {
                    router.push('/collections/0xfBFb463C184b93C2d8659fe0311599001217FE68')
                }, 3000)
            })
            .catch((error) => {
                console.error(error);
